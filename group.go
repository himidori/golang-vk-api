...
func (client *VKClient) GroupSearch(query string, count int) (*GroupSearchResult, error) {
	params := url.Values{}
	params.Set("q", query)
...
func (client *VKClient) GroupGet(userID int, count int) (*GroupSearchResult, error) {
	params := url.Values{}
	params.Set("user_id", strconv.Itoa(userID))
	params.Set("count", strconv.Itoa(count))
